...
var questionList = [
    ...
    '<div><br><button style="-webkit-appearance:button;" onClick="next()">Next</button></div>',
    ...
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="b" value="24">'+
    '<label for="b">Quite a bit of time (2 hours/month = 24 hours/year)</label><br>'+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="c" value="12">'+
    '<label for="c">A moderate amount of time (1 hour/month = 12 hours/year)</label><br>'+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="d" value="4">'+
    '<label for="d">Very little time (1 hour/quarter = 4 hours/year)</label><br>'+
    '<div><br><button style="-webkit-appearance:button;" onClick="radioNext()">Next</button></div>',

    "<p><strong>Q5. Is your current portfolio well-constructed? If not, how much better off would you be if it were?</strong></p>"+
    "<p><em>Please select one of the following:</em></p>"+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="a" value="0.0045">'+
    ...
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="b" value="0.0025">'+
    ...
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="c" value="0">'+
    ...
    "<p><em>Please select one of the following:</em></p>"+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="a" value="0.005">'+
    ...
    "<p><em>Please select one of the following:</em></p>"+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="a" value="0.0035">'+
    '<label for="a">I never rebalance. (Annual benefit = 0.35%)</label><br>'+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="b" value="0.002">'+
    ...
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="c" value="0.001">'+
    ...
    "<p><em>Please select one of the following:</em></p>"+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="a" value="0.001">'+
    '<label for="a">I do not proactively harvest losses, and I am in a high marginal tax bracket. (Annual benefit = 0.10%)</label><br>'+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="b" value="0.0005">'+
    ...
    "<p><em>Please select one of the following:</em></p>"+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="a" value="0.015">'+
    '<label for="a">I am likely to make emotional financial decisions. (Annual benefit = 1.5%)</label><br>'+
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="b" value="0.005">'+
    ...
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="a" value="0.007">'+
    ...
    '<input style="-webkit-appearance:radio;" type="radio" name="answer" id="b" value="0">'+
